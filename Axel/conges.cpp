...
QSqlQueryModel * Conges::afficher()
{
  ...
  model->setQuery("select * from conges") ;
          model->setHeaderData(4,Qt::Horizontal, QObject::tr("ID_CONGES"));
          model->setHeaderData(3,Qt::Horizontal, QObject::tr("ID_ADMIN"));
          model->setHeaderData(2,Qt::Horizontal, QObject::tr("ID_OUVRIER"));
          model->setHeaderData(0,Qt::Horizontal, QObject::tr("DATE_DEPART"));
          model->setHeaderData(1,Qt::Horizontal, QObject::tr("DATE_RETOUR"));
...
{
    tab->setHeaderData(4,Qt::Horizontal, QObject::tr("ID_CONGES"));
    tab->setHeaderData(3,Qt::Horizontal, QObject::tr("ID_ADMIN"));
    tab->setHeaderData(2,Qt::Horizontal, QObject::tr("ID_OUVRIER"));
    tab->setHeaderData(0,Qt::Horizontal, QObject::tr("DATE_DEPART"));
    tab->setHeaderData(1,Qt::Horizontal, QObject::tr("DATE_RETOUR"));
    tab->setHeaderData(5,Qt::Horizontal, QObject::tr("SOLDE"));
}
return tab;
}
...
QSqlQueryModel * Conges::afficher_conges_comboBox()
{
    QSqlQueryModel * model= new QSqlQueryModel();
    model->setQuery("select id_conges from conges");
    return model;
}
